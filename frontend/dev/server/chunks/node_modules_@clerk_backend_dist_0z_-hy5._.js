...
"[project]/node_modules/@clerk/backend/dist/chunk-7E7A3JZN.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@clerk/backend/dist/chunk-7KNTREEZ.mjs [middleware] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$keys$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@clerk/shared/dist/keys.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$retry$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@clerk/shared/dist/retry.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@clerk/backend/dist/chunk-7E7A3JZN.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$RZ7A7F6X$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@clerk/backend/dist/chunk-RZ7A7F6X.mjs [middleware] (ecmascript) <locals>");
...
var AuthenticateContext = class {
   ...
   */ get sessionToken() {
    ...
    usesSuffixedCookies() {
        ...
        const { data: sessionData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(session);
        const sessionIat = sessionData?.payload.iat || 0;
        const { data: suffixedSessionData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(suffixedSession);
   ...
   */ isKnownClerkReferrer() {
    ...
    tokenHasIssuer(token) {
        const { data, errors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(token);
        if (errors) {
            return false;
        }
...
async function fetchJWKSFromBAPI(apiUrl, key, apiVersion) {
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["runtime"].fetch(url.href, {
        headers: {
...
async function resolveKeyAndVerifyJwt(token, kid, options, headerType) {
    try {
        ...
        const { data: payload, errors: verifyErrors } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["verifyJwt"])(token, {
            ...options,
            key,
            ...headerType ? {
                headerType
...
var OrganizationAPI = class extends AbstractAPI {
    ...
    async updateOrganizationLogo(organizationId, params) {
        this.requireId(organizationId);
        const formData = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["runtime"].FormData();
...
function buildRequest(options) {
    const requestFn = async (requestOptions)=>{
        ...
        try {
            if (formData) {
                res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["runtime"].fetch(finalUrl.href, {
                    method,
                    headers,
                    body: formData
                });
...
async function verifyToken(token, options) {
    const { data: decodedResult, errors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(token);
    if (errors) {
        return {
            errors
        };
    ...
    try {
        ...
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["verifyJwt"])(token, {
            ...options,
            key
        });
    } catch (error) {
...
async function verifyMachineAuthToken(token, options) {
    if (isJwtFormat(token)) {
        let decodedResult;
        try {
            const { data, errors: decodeErrors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(token);
            if (decodeErrors) {
...
async function verifyHandshakeJwt(token, { key }) {
    const { data: decoded, errors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(token);
    if (errors) {
        throw errors[0];
    }
    const { header, payload } = decoded;
    const { typ, alg } = header;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["assertHeaderType"])(typ);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["assertHeaderAlgorithm"])(alg);
    const { data: signatureValid, errors: signatureErrors } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["hasValidSignature"])(decoded, key);
    if (signatureErrors) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$RZ7A7F6X$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenVerificationError"]({
            reason: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$RZ7A7F6X$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenVerificationErrorReason"].TokenVerificationFailed,
...
var authenticateRequest = async (request, options)=>{
    ...
    async function refreshToken(authenticateContext2) {
        ...
        const { data: decodeResult, errors: decodedErrors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(expiredSessionToken);
    ...
    async function authenticateRequestWithTokenInCookie() {
        ...
        const { data: decodeResult, errors: decodedErrors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7E7A3JZN$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(authenticateContext.sessionTokenInCookie);
        if (decodedErrors) {
...
function createClerkClient(options) {
    ...
    const apiClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7KNTREEZ$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createBackendApiClient"])(opts);
    const requestState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$7KNTREEZ$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAuthenticateRequest"])({
        options: opts,
        apiClient
    });
...
//# sourceMappingURL=node_modules_%40clerk_backend_dist_0z_-hy5._.js.map